...
{
  public PublicHttpHandlerPipelineBuilder(IServiceProvider serviceProvider, ILogger<PublicHttpHandlerPipelineBuilder> logger, IOptions<ApiSettings> apiSettings)
